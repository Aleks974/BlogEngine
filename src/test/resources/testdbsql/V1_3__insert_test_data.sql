...
VALUES (1, true, 'NEW', 1, 2, '2021-08-11 12:00:00', 'Пост1', 'Текст1', 0),
(2, true, 'ACCEPTED', 1, 3, '2021-08-11 13:00:00', 'Пост2', 'Текст2', 0),
(3, true, 'ACCEPTED', 1, 3, '2021-08-11 14:00:00', 'Пост3', 'Текст3', 0),
(4, true, 'ACCEPTED', 1, 1, '2021-08-11 15:00:00', 'Пост4', 'Текст4', 0);;

-- post_comments

INSERT INTO post_comments (id, post_id, user_id, time, text)
VALUES (1, 2, 2, '2021-08-12 13:10:00', 'Комментарий1'),
(2, 3, 2, '2021-08-12 14:10:00', 'Комментарий2'),
(3, 2, 1, '2021-08-12 15:10:00', 'Комментарий3');;
